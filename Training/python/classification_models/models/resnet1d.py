...
def residual_conv_block(filters, stage, block, strides=1, attention=None, cut='pre'):
...
def residual_bottleneck_block(filters, stage, block, strides=None, attention=None, cut='pre'):
    ...
    def layer(input_tensor):
        ...
        x = layers.Activation('relu', name=relu_name + '2')(x)
        x = layers.ZeroPadding1D(padding=1)(x)
        x = layers.Conv1D(filters, 3, strides=strides, name=conv_name + '2', **conv_params)(x)
...
def ResNet(model_params, input_shape=None, input_tensor=None, mask_tensor=None, include_top=True,
    ...
    if mask_tensor is not None:
        img_input = tf.multiply(img_input, mask_tensor)
    ...
    x = layers.ZeroPadding1D(padding=1)(x)
    x = layers.Conv1D(init_filters, 3, strides=1, name='conv0', **conv_params)(x)
...
def ResNet18(input_shape=None, input_tensor=None, mask_tensor=None, weights=None, classes=1000, include_top=True, **kwargs):
    return ResNet(
...
def ResNet34(input_shape=None, input_tensor=None, mask_tensor=None, weights=None, classes=1000, include_top=True, **kwargs):
    return ResNet(
...
def ResNet50(input_shape=None, input_tensor=None, mask_tensor=None, weights=None, classes=1000, include_top=True, **kwargs):
    return ResNet(
...
def ResNet101(input_shape=None, input_tensor=None, mask_tensor=None, weights=None, classes=1000, include_top=True, **kwargs):
    return ResNet(
...
def ResNet152(input_shape=None, input_tensor=None, mask_tensor=None, weights=None, classes=1000, include_top=True, **kwargs):
    return ResNet(
...
def SEResNet18(input_shape=None, input_tensor=None, mask_tensor=None, weights=None, classes=1000, include_top=True, **kwargs):
    return ResNet(
...
def SEResNet34(input_shape=None, input_tensor=None, mask_tensor=None, weights=None, classes=1000, include_top=True, **kwargs):
    return ResNet(
