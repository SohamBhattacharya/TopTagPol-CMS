...
from .models import resnet1d as rn1d
...
class ModelsFactory:
    _models = {
        ...
        # ResNets1ds
        'resnet1d18': [rn1d.ResNet18, rn1d.preprocess_input],
        'resnet1d34': [rn1d.ResNet34, rn1d.preprocess_input],
        'resnet1d50': [rn1d.ResNet50, rn1d.preprocess_input],
        'resnet1d101': [rn1d.ResNet101, rn1d.preprocess_input],
        'resnet1d152': [rn1d.ResNet152, rn1d.preprocess_input],
