...
#networkName = "particle_net_mod1b_ak8_with-WZ_2022-05-11_18-55-28"
networkName = "particle_net_mod1b_ak8_noSD_2022-06-10_17-14-23"
...
d_curveInfo_template = {
    ...
    "friends": [
        {
            "dir":                f"/nfs/dust/cms/user/sobhatta/work/TopTagPol/Training/training_results/classifier_trees/{networkName}",
            "tag":                None,
            "usefriendlist":      None,
            "tree":               "tree",
        },
    ...
    "classifier":     "epoch22_lepTop_vs_qcd",
...
#l_sample = [
#    ("TTJets", "QCD")
#    #("TTJets_HT-800to1200", "QCD")
#    #("TTJets_HT-1200to2500", "QCD")
#    ("ZprimeToTT_M2000_W20", "QCD")
#    ("ZprimeToTT_M4000_W40", "QCD")
#    ("Wprimetotb_M4000W40", "QCD")
#    ("Wprimetotb_M6000W40", "QCD")
#]
#
#l_color = [
#    1,
...
for pdgidIdx in range(0, len(l_pdgid)) :
    ...
    d_config = {
        ...
        "outdir": f"plots/ROCs/{networkName}/{era}/{jetName}",
    }
